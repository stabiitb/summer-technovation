    ...
    <body cz-shortcut-listen="true">
       ...
       <div id="main" class="collapsfix relative" style="opacity: 1;">
           ...
           <header id="video" class="scrolling">
                 ...
                 <div id='cssmenu'>
                  <ul>
                     ...
                     <li class='has-sub'><a href='#'><span>Ongoing Projects</span></a>
                        <ul>
                           <li><a href='http://stab-iitb.org/wiki/CNC_Laser_Cutting_Machine' target="_blank"><span>CNC Laser Cutting Machine</span></a></li>
                           <li><a href='http://stab-iitb.org/wiki/DUT' target="_blank"><span>DUT</span></a></li>
                           <li><a href='http://stab-iitb.org/wiki/Foetal_Heartrate_Measurement' target="_blank"><span>Foetal Heartrate Measurement</span></a></li>
                           <li><a href='http://stab-iitb.org/wiki/Blue-Ray' target="_blank"><span>Blue-Ray</span></a></li>
                           <li class='last'><a href='http://stab-iitb.org/wiki/Tilt-Rotor' target="_blank"><span>Tilt-Rotor</span></a></li>
                        </ul>
                     </li>
               ...
               <div class="video relative" style="height: 490px;opacity:100;" >
           			<div id="youtube" class="relative" style="height: 490px;">
                    <div class="close absolute"><a href="#"></a></div>
                    </div>
                   <div class="description centerAbsolute" style="margin-top: -145px;">
                       <h1 class="proximaBold antialiased">Summer Technovation</h1>
                       <h2 class="proximaLite antialiased">Dont think out of the box. Just break the box</h2>
                       <a href="#" onclick="return false;" class="play clearfix proximaBold relative"><span class="cta floatL">Registration over</span></a>
                      
                       <div class="share clearfix">
                      
                           <ul class="shareList ul-nostyle clearfix">
                               <li class="floatL fb"><a href="#facebook"><img src="./assets/share-fb@2x.png" width="7" height="18" alt="Facebook"></a></li>
                               <li class="floatL tw"><a href="#twitter"><img src="./assets/share-tw@2x.png" width="18" height="18" alt="Twitter"></a></li>
                               <li class="floatL in"><a href="#linkedin"><img src="./assets/share-in@2x.png" width="18" height="18" alt="LinkedIn"></a></li>
                               <li class="floatL g"><a href="#google"><img src="./assets/share-g@2x.png" width="18" height="18" alt="Google+"></a></li>
                           </ul>
                       </div>
                   </div>
               </div>
           ...
           <ul class="ul-nostyle">
           <li><a href="#video" style="background-color: rgb(255, 255, 255); background-position: initial initial; background-repeat: initial initial;"><span class=""></span></a></li>
...
<div class="scroll1 proximaBold collapsfix">
               <h4 class="scrollText">What is Summer Technovation?</h4>
               <div class="next"><a href="#whatisbigdata"></a></div>
           </div>
           
           <div id="01" class="number proximaBold"><div>1</div></div>
           
           <section id="whatisbigdata" class="collapsfix scrolling mainWidth sectionPadding">
...
<div>Manmohan (9769486341 | manmohanmandhana000@gmail.com )</div>
        ...
        <br>
        <p>Site built by <strong><a href="http://www.cse.iitb.ac.in/~prateekchandan/">Prateek chandan</a></strong><br>and Akash Kishore</p>      
</div>
