...
/*-----------------------
	...
	function shareEv(e){
		...
		if($(this).attr('href')=='#facebook'){
			window.open("http://www.facebook.com/sharer.php?u=http%3Astab-iitb.org","Facebook Share","height=300, width=600,scrollbars=yes");
			
		}else if($(this).attr('href')=='#twitter'){
			window.open("http://twitter.com/share?text=Summer%20Technivation%20launched%20by%20technovation,%20STAB,%20IIT BOMBAY%20&url=http%3A//stab-iitb.org&hashtags=technovation","Twitter Share","height=300, width=600,scrollbars=yes");
			
		}else if($(this).attr('href')=='#linkedin'){
			window.open("http://www.linkedin.com/shareArticle?mini=true&url=http%3A//stab-iitb.org&title=Technovation","Linkedin Share","height=400, width=600,scrollbars=yes");
			
		}else if($(this).attr('href')=='#google'){
			window.open("https://plus.google.com/share?url=http%3A//stab-iitb.org","Google+ Share","height=300, width=600,scrollbars=yes");
...
/*
	...
	function showVideo(){
		...
		$('.video #youtube').append('<iframe id="player" src="https://stab.typeform.com/to/ZjkE8g?embed=full" allowfullscreen></iframe>');
